...
<div class="container" id="profile"> 
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <img src="<?php echo !empty($userInfo['profile_img']) ? SITEURL. "uploads/profilephotos/".$userInfo['profile_img'] : "https://cdn-icons-png.flaticon.com/512/21/21104.png"; ?>" alt="" class="rounded-circle profile-img"/>
            </div>
